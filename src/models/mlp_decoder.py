...
class MLPDecoder(nn.Module):
    def __init__(self, input_size: int, num_outputs: int, hidden_layers=None, dropout_rate=0.1):
        ...
        layers.append(nn.Linear(current_input_size, num_outputs))  # Output layer
