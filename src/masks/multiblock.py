...
class MaskCollator(object):
    def __init__(
        ...
        self.length = input_length // patch_size
    ...
    def _sample_block_size(self, generator, scale):
        ...
        # -- Compute block length (given scale)
    ...
    def _sample_block_mask(self, l, acceptable_regions=None):
        ...
        while not valid_mask:
            ...
            if acceptable_regions is not None:
                pass  # Skipping for simplicity; adapt if you have a specific constraint
    ...
    def __call__(self, batch):
        '''
        Create encoder and predictor masks when collating data into a batch
        '''
        B = len(batch)
